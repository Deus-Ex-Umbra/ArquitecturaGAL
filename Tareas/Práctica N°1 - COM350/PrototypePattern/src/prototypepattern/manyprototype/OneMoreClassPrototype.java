...
public class OneMoreClassPrototype implements Prototype{
    Object atribute1;
    Object atribute2;
     //... more Atributes
    
    public OneMoreClassPrototype(Object _atribute1, Object _atribute2) {
    ...
    public Prototype clone() {
        try {
            return (OneMoreClassPrototype) super.clone();
        } catch (Exception _ex) {
