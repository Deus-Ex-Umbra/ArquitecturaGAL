...
public class OtherClassPrototype implements Prototype {
    Object atribute1;
    Object atribute2;
     //... more Atributes
    
    public OtherClassPrototype(Object _atribute1, Object _atribute2) {
    ...
    public Prototype clone() {
        try {
            return (OtherClassPrototype) super.clone();
        } catch (Exception _ex) {
